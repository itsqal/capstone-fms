        ...
        <form action="/login" method="POST"
            ...
            <div class="flex justify-end mb-6">
                <a href="{{  route('password.request') }}"
                    class="text-xs sm:text-sm text-[#9747FF] hover:text-[#7F56D9] font-medium transition-colors hover:underline">Lupa password?</a>
            </div>
            ...
            <div class="flex justify-center mt-6">
                <span class="text-xs sm:text-sm text-[#6F6C90] font-medium">
                    Belum memiliki akun? <a href="{{ route('register') }}"
                        class="text-[#9747FF] hover:text-[#7F56D9] font-semibold hover:underline ml-1">Register</a>
                </span>
            </div>
        </form>
    </div>
